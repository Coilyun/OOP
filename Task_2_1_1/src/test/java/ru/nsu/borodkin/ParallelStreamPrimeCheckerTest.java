...
class ParallelStreamPrimeCheckerTest {
    ...
    void testHaveNotPrimeSequential_10() {
        ParallelStreamPrimeChecker checker = new ParallelStreamPrimeChecker();
    ...
    @Test
    @Order(2)
    void testHaveNotPrimeSequential_1000() {
        ParallelStreamPrimeChecker checker = new ParallelStreamPrimeChecker();
    ...
    @Test
    @Order(3)
    void testHaveNotPrimeSequential_100000() {
        ParallelStreamPrimeChecker checker = new ParallelStreamPrimeChecker();
    ...
    @Test
    @Order(4)
    void testHaveNotPrimeSequential_1000000() {
        ParallelStreamPrimeChecker checker = new ParallelStreamPrimeChecker();
    ...
    @Test
    @Order(5)
    void testHaveNotPrimeSequential_10000000() {
        ParallelStreamPrimeChecker checker = new ParallelStreamPrimeChecker();
